export const skillDescriptions = {
	...
	virtualagents:
		'A tool for creating chatbots and virtual agents to automate customer interactions and support services.',
	flstudio:
		'A comprehensive digital audio workstation (DAW) used for music production, allowing users to compose, arrange, record, edit, mix, and master music tracks with a wide range of built-in tools and plugins.',
	piano: 'I play the piano and have a good understanding of music theory and composition.',
	acousticGuitar:
		'I play classical und strumming patterns on the acoustic guitar for music production.',
	...
	audioMixing:
		'I have experience in audio mixing, including balancing levels, panning, equalization, and effects processing (Production & Live).',
	audioProduction:
		'I have experience in audio production, including recording, editing, and arranging audio tracks.',
	daisyUi:
		'A modern, responsive, and customizable UI framework for building web applications with a focus on accessibility and user experience.',
	gurobi:
		'A mathematical optimization solver used for solving linear programming, mixed-integer programming, and other optimization problems.',
	nextjs:
	...
	lwc:
		"A component-based UI framework on the Salesforce platform used to build fast, reusable, and standards-based web components.",
	apex:

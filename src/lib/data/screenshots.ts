...
export const ScreenshotsAssets = {
	...
	// Jugarden Website
	jugardenHomePC: path('jugarden/pc.jpeg'),
	jugardenHomeMobile: path('jugarden/mobile.jpeg'),
	jugardenPreview: path('jugarden/preview.jpeg'),
	jugardenContact: path('jugarden/contact.jpeg'),
	jugardenTestimonials: path('jugarden/testimonials.jpeg')
};
